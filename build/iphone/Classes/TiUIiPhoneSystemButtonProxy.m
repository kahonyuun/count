...
MAKE_SYSTEM_PROP(ACTIVITY,UIcountNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIcountNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIcountNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIcountNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIcountNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIcountNativeItemContactAdd);
