...
// in simulator we redefine to format for count Developer console
...
{\
	NSString * exceptionName = [@"org.count." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.count";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIcountNativeItemNone = -1, 
	UIcountNativeItemSpinner = -2,
	UIcountNativeItemProgressBar = -3,
	
	UIcountNativeItemSlider = -4,
	UIcountNativeItemSwitch = -5,
	UIcountNativeItemMultiButton = -6,
	UIcountNativeItemSegmented = -7,
	
	UIcountNativeItemTextView = -8,
	UIcountNativeItemTextField = -9,
	UIcountNativeItemSearchBar = -10,
	
	UIcountNativeItemPicker = -11,
	UIcountNativeItemDatePicker = -12,
	
	UIcountNativeItemInfoLight = -13,
	UIcountNativeItemInfoDark = -14,
	
	UIcountNativeItemDisclosure = -15,
	
	UIcountNativeItemContactAdd = -16
};
